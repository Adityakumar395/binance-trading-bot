...
git clone https://github.com/Adityakumar395/binance-trading-bot.git

cd binance-trading-bot
   
**2. Install Dependencies:**

pip install -r requirements.txt(Dependencies include python-binance and python-dotenv)

**3. Environment Configuration:** 

Create a file named .env in the root directory and add your Binance Testnet keys.
